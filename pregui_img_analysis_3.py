...
def main():
    ...
    plateKeys = ["date_time","temperature","plate_id","subwells"]
    ...
    for im_idx, im_path in tqdm(sorted(dict_image_path_subwells.items())):
        ...
        a[plate_id]["subwells"][str_currentWell]["subwell"] = subwell
        a[plate_id]["subwells"][str_currentWell]["image_path"] = os.path.abspath(im_path)
